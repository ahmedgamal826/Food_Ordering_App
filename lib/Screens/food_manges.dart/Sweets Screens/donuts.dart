...
class Donuts extends StatefulWidget {
  ...
  @override
  State<Donuts> createState() => _DonutState();
}

class _DonutState extends State<Donuts> {
  String searchQuery = '';
